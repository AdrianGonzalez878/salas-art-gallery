...
const testimonios = [
  {
    nombre: 'Mariana G.',
    texto: 'Compré un anillo para mi mamá y quedó encantada. La calidad de la plata es excelente y el empaque es muy bonito. Definitivamente volvería a comprar.',
    estrellas: 5,
  },
  {
    nombre: 'Sofía R.',
    texto: 'Me sorprendió lo rápido que llegó mi pedido y lo bien que estaba empacado. Los aretes son preciosos, exactamente como en las fotos. ¡100% recomendados!',
    estrellas: 5,
  },
  {
    nombre: 'Daniela M.',
    texto: 'Llevo años buscando joyería de plata genuina y por fin encontré Conchita Plata. El collar que pedí es hermoso y el precio muy justo para la calidad que tiene.',
    estrellas: 5,
  },
]
